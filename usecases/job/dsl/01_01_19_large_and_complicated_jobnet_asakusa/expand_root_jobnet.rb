...
jobnet("#{BATCH_ID_QUALIFIER}.001", :instance_name => "test_server1", :credential_name => "test_credential1") do 
    ...
    jobnet("STAGE_GRAPH") do
        ...
        hadoop_job_run("stage0001", "$HOME/tengine_job_test.sh 2 job_function_test_006", :to => "large_and_complicated_root_jobnet.001") do
            hadoop_job("SplyImp.SplyMargeAndSeparate.stage0001")
        end
        hadoop_job_run("stage0002", "$HOME/tengine_job_test.sh 2 job_function_test_007", :to => "large_and_complicated_root_jobnet.001") do
