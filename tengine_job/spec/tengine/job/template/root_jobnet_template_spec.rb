...
describe Tengine::Job::Template::RootJobnet do
  ...
  describe :generate do
    ...
    context "rjn0012" do
      ...
      it "実行用ジョブネットを生成する" do
        ...
        root.children[0].should be_a(Tengine::Job::Runtime::Start)
        root.children[1].tap{|j| j.should be_a(Tengine::Job::Runtime::Jobnet); j.name.should == "j1000"}
        root.children[2].tap{|j| j.should be_a(Tengine::Job::Runtime::Jobnet); j.name.should == "j2000"}
        root.children[3].tap{|j| j.should be_a(Tengine::Job::Runtime::Jobnet); j.jobnet_type_key.should == :finally}
        root.children[4].should be_a(Tengine::Job::Runtime::End)
        root.edges.length.should == 3
        root.edges[0].tap{|edge| edge.origin.should == root.children[0]; edge.destination.should == root.children[1]}
        root.edges[1].tap{|edge| edge.origin.should == root.children[1]; edge.destination.should == root.children[2]}
        ...
        root.children[1].tap do |j1000|
          ...
          j1000.children[0].should be_a(Tengine::Job::Runtime::Start)
          j1000.children[1].tap{|j| j.should be_a(Tengine::Job::Runtime::Jobnet); j.name.should == "j1100"}
          j1000.children[2].tap{|j| j.should be_a(Tengine::Job::Runtime::Jobnet); j.name.should == "j1200"}
          j1000.children[3].tap{|j| j.should be_a(Tengine::Job::Runtime::Jobnet); j.jobnet_type_key.should == :finally}
          j1000.children[4].should be_a(Tengine::Job::Runtime::End)
          ...
          j1000.children[3].tap do |j1f00|
            ...
            j1f00.children[0].should be_a(Tengine::Job::Runtime::Start)
            j1f00.children[1].tap{|j| j.should be_a(Tengine::Job::Runtime::Jobnet); j.name.should == "j1f10"}
            j1f00.children[2].tap{|j| j.should be_a(Tengine::Job::Runtime::Jobnet); j.jobnet_type_key.should == :finally}
            j1f00.children[3].should be_a(Tengine::Job::Runtime::End)
  ...
  describe "名前で検索" do
    ...
    [:find_by_name, :find_by_name!].each do |method_name|
      context "#{method_name}は見つかった場合はそれを返す" do
        it "バージョン指定なし" do
          template = Tengine::Job::Template::RootJobnet.send(method_name, "rjn0002")
          template.should be_a(Tengine::Job::Template::RootJobnet)
          template.name.should == "rjn0002"
          template.dsl_version.should == "2"
        end

        it "バージョン指定あり" do
          template = Tengine::Job::Template::RootJobnet.send(method_name, "rjn0001", :version => "1")
          template.should be_a(Tengine::Job::Template::RootJobnet)
    ...
    context ":find_by_nameは見つからなかった場合はnilを返す" do
      it "バージョン指定なし" do
        Tengine::Job::Template::RootJobnet.find_by_name("rjn0001").should == nil
      end

      it "バージョン指定あり" do
        Tengine::Job::Template::RootJobnet.find_by_name("rjn0002", :version => "1").should == nil
      end
    end
    ...
    context ":find_by_name!は見つからなかった場合はTengine::Errors::NotFoundをraiseする" do
      it "バージョン指定なし" do
        begin
          Tengine::Job::Template::RootJobnet.find_by_name!("rjn0001")
          fail
        rescue Tengine::Errors::NotFound => e
          e.message.should == "Tengine::Job::Template::RootJobnet named \"rjn0001\" not found"
        end
      end

      it "バージョン指定あり" do
        begin
          Tengine::Job::Template::RootJobnet.find_by_name!("rjn0002", :version => "1")
          fail
        rescue Tengine::Errors::NotFound => e
          e.message.should == "Tengine::Job::Template::RootJobnet named \"rjn0002\" with {:version=>\"1\"} not found"
        end
      end
    end
