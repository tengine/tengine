...
機能: アプリケーション運用者がジョブを強制停止する
  ...
  シナリオ: [正常系]fork前、ルートジョブネットの最初
    ...
    ならば 以下の行が表示されていること
    |ID|ジョブ名|説明|実行スクリプト|接続サーバ名|認証情報名|開始日時|終了日時|ステータス|次のジョブ|操作|
    |  |j1     |j1 |            |test_server1|test_credential1|2011/11/25 14:43:22 | |タイムアウト強制停止済|j2, j3|ステータス変更 再実行|
  ...
  シナリオ: [正常系]実行中のジョブが２つで２つともタイムアウト強制停止
    ...
    かつ 以下の行が表示されていること
    |ID|ジョブ名|説明|実行スクリプト|接続サーバ名|認証情報名|開始日時|終了日時|ステータス|次のジョブ|操作|
    |  |j1     |j1 |            |test_server1|test_credential1|2011/11/25 14:43:22 | |実行中|j2, j3|ステータス変更 再実行|
    |  |j2     |j2 |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更 再実行|
    |  |j3     |j3 |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更 再実行|
    |  |j4     |j4 |            |test_server1|test_credential1| | |初期化済| |ステータス変更 再実行|
    |  |finally|finally|            |test_server1|test_credential1| | |初期化済| |ステータス変更 再実行|
    ...
    |  |j2     |j2 |            |test_server1|test_credential1| | |タイムアウト強制停止済|j4|ステータス変更 再実行|
    |  |j3     |j3 |            |test_server1|test_credential1| | |タイムアウト強制停止済|j4|ステータス変更 再実行|
    |  |j4     |j4 |            |test_server1|test_credential1| | |初期化済| |ステータス変更 再実行|
    |  |finally|finally|            |test_server1|test_credential1| | |初期化済| |ステータス変更 再実行|
    |  |jn0004_f|jn_0004_f|            |test_server1|test_credential1| | |初期化済| |ステータス変更 再実行|
  ...
  シナリオ: [正常系]実行中のジョブが1つで片方がエラー終了している状態でタイムアウト強制停止
    ...
    |  |j1     |j1 |            |test_server1|test_credential1|2011/11/25 14:43:22 | |正常終了|j2, j3|ステータス変更 強制停止 |
    |  |j2     |j2 |            |test_server1|test_credential1| | |実行中|j4|ステータス変更|
    |  |j3     |j3 |            |test_server1|test_credential1| | |エラー終了|j4|ステータス変更|
    |  |j4     |j4 |            |test_server1|test_credential1| | |初期化済| |ステータス変更|
    |  |finally|finally|            |test_server1|test_credential1| | |初期化済| |ステータス変更|
    |  |jn0004_f|jn_0004_f|            |test_server1|test_credential1| | |初期化済| |ステータス変更|
  ...
  シナリオ: [正常系]finally実行中にタイムアウト強制停止
    ...
    |  |finally|finally|            |test_server1|test_credential1| | |タイムアウト強制停止済| |ステータス変更 再実行|
    |  |jn0004_f|jn_0004_f|            |test_server1|test_credential1| | |タイムアウト強制停止済| |ステータス変更 再実行|
...
#--retry2--
  ...
  シナリオ: [正常系]ルートジョブネット内のジョブネット内のジョブ
    ...
    ならば "ジョブネット監視画面"を表示していること
    かつ 以下の行が表示されていること
    |  |j1     |j1 |            |test_server1|test_credential1|2011/11/25 14:43:22 | |準備中|j2, jn4|ステータス変更 |
    |  |j2     |j2 |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更 強制停止|
    |  |jn4     |jn4 |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更|
    |  |  j41   |j41 |            |test_server1|test_credential1| | |初期化済|j42,j43|ステータス変更|
    ...
    |  |jn4     |jn4 |            |test_server1|test_credential1| | |タイムアウト強制停止|j4|ステータス変更|
    |  |  j41   |j41 |            |test_server1|test_credential1| | |タイムアウト強制停止|j42,j43|ステータス変更|
    |  |  j42   |j42 |            |test_server1|test_credential1| | |初期化済|j44|ステータス変更|
    |  |  j43   |j43 |            |test_server1|test_credential1| | |初期化済|j44|ステータス変更|
    |  |  j44   |j44 |            |test_server1|test_credential1| | |初期化済| |ステータス変更|
    |  |  finally   |finally |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更|
  ...
  シナリオ: [正常系]ルートジョブネット内のジョブネット内で実行中のジョブが２つ
    ...
    |  |j1     |j1 |            |test_server1|test_credential1|2011/11/25 14:43:22 | |正常終了|j2, jn4|ステータス変更 |
    |  |j2     |j2 |            |test_server1|test_credential1| | |正常終了|j4|ステータス変更 強制停止|
    |  |jn4     |jn4 |            |test_server1|test_credential1| | |タイムアウト強制停止済|j4|ステータス変更|
    |  |  j41   |j41 |            |test_server1|test_credential1| | |正常終了|j42,j43|ステータス変更|
    |  |  j42   |j42 |            |test_server1|test_credential1| | |タイムアウト強制停止済|j44|ステータス変更|
    |  |  j43   |j43 |            |test_server1|test_credential1| | |タイムアウト強制停止済|j44|ステータス変更|
    |  |  j44   |j44 |            |test_server1|test_credential1| | |初期化済| |ステータス変更|
    |  |  finally   |finally |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更|
    |  |  jn4_f   |jn4_f |            |test_server1|test_credential1| | |初期化済| |ステータス変更|
    |  |j4     |j4 |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更|
  ...
  シナリオ: [正常系]ルートジョブネット内のジョブネット内で実行中のジョブが1つ_片方がエラー終了
    ...
    |  |  j41   |j41 |            |test_server1|test_credential1| | |正常終了|j42,j43|ステータス変更|
    |  |  j42   |j42 |            |test_server1|test_credential1| | |タイムアウト強制停止済|j44|ステータス変更|
    |  |  j43   |j43 |            |test_server1|test_credential1| | |エラー終了|j44|ステータス変更|
    |  |  j44   |j44 |            |test_server1|test_credential1| | |初期化済| |ステータス変更|
    |  |  finally   |finally |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更|
    |  |  jn4_f   |jn4_f |            |test_server1|test_credential1| | |初期化済| |ステータス変更|
    |  |j4     |j4 |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更|
  ...
  シナリオ: [正常系]ルートジョブネット内のジョブネット内のfinallyが実行中にタイムアウト強制停止
    ...
    |  |  j43   |j43 |            |test_server1|test_credential1| | |正常終了|j44|ステータス変更|
    |  |  j44   |j44 |            |test_server1|test_credential1| | |エラー終了| |ステータス変更|
    |  |  finally   |finally |            |test_server1|test_credential1| | |タイムアウト強制停止済|j4|ステータス変更|
    |  |  jn4_f   |jn4_f |            |test_server1|test_credential1| | |タイムアウト強制停止済| |ステータス変更|
    |  |j4     |j4 |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更|
    |  |finally|finally|            |test_server1|test_credential1| | |初期化済| |ステータス変更|
    |  |  jn0005_fjn|jn_0005_fjn|            |test_server1|test_credential1|| |初期化済|jn0005_f|ステータス変更|
    |  |    jn0005_f1|jn_0005_f1|            |test_server1|test_credential1| | |初期化済|jn0005_f2|ステータス変更|
  ...
  シナリオ: [正常系]ルートジョブネット内のジョブネット内のfinallyのfinallyが実行中にタイムアウト強制停止
    ...
    |  |j1     |j1 |            |test_server1|test_credential1|2011/11/25 14:43:22 | |正常終了|j2, jn4|ステータス変更 |
    |  |j2     |j2 |            |test_server1|test_credential1| | |正常終了|j4|ステータス変更 強制停止|
    |  |jn4     |jn4 |            |test_server1|test_credential1| | |エラー終了|j4|ステータス変更|
    |  |  j41   |j41 |            |test_server1|test_credential1| | |正常終了|j42,j43|ステータス変更|
    |  |  j42   |j42 |            |test_server1|test_credential1| | |正常終了|j44|ステータス変更|
    |  |  j43   |j43 |            |test_server1|test_credential1| | |正常終了|j44|ステータス変更|
    |  |  j44   |j44 |            |test_server1|test_credential1| | |エラー終了| |ステータス変更|
    ...
    |  |  jn4_f   |jn4_f |            |test_server1|test_credential1| | |タイムアウト強制停止済| |ステータス変更|
    |  |j4     |j4 |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更|
    |  |finally|finally|            |test_server1|test_credential1| | |タイムアウト強制停止済| |ステータス変更|
    |  |  jn0005_fjn|jn_0005_fjn|            |test_server1|test_credential1|| |タイムアウト強制停止済|jn0005_f|ステータス変更|
    |  |    jn0005_f1|jn_0005_f1|            |test_server1|test_credential1| | |正常終了|jn0005_f2|ステータス変更|
    |  |    jn0005_f2|jn_0005_f2|            |test_server1|test_credential1| | |エラー終了| |ステータス変更|
    |  |    finally|finally|            |test_server1|test_credential1| | |タイムアウト強制停止済| |ステータス変更|
    |  |      jn0005_fif|jn_0005_fif|            |test_server1|test_credential1| | |タイムアウト強制停止済| |ステータス変更|
    |  |  jn0005_f|jn_0005_f|            |test_server1|test_credential1| | |初期化済| |ステータス変更|
  ...
  シナリオ: [正常系]ジョブネットの中のジョブネット内にあるジョブを実行中にタイムアウト強制停止
    ...
    ならば 以下の行が表示されていること
    |ID|ジョブ名|説明|実行スクリプト|接続サーバ名|認証情報名|開始日時|終了日時|ステータス|次のジョブ|操作|
    |  |jn1          |jn1 |            |test_server1|test_credential1|2011/11/25 14:43:22 | |タイムアウト強制停止済|jn2|ステータス変更 |
    |  |  jn11       |jn11 |            |test_server1|test_credential1| | |タイムアウト強制停止済|j12|ステータス変更 強制停止|
    |  |    j111     |jn111 |            |test_server1|test_credential1| | |タイムアウト強制停止済|j112|ステータス変更|
    |  |    j112     |j112|            |test_server1|test_credential1| | |初期化済||ステータス変更|
    |  |    finally  |finally |            |test_server1|test_credential1| | |初期化済|finally|ステータス変更|
    |  |      jn11_f |jn11_f |            |test_server1|test_credential1| | |初期化済|jn11_f|ステータス変更|
    |  |  j12        |j12 |            |test_server1|test_credential1| | |初期化済||ステータス変更|
    ...
    ならば 以下の行が表示されていること
    |ID|ジョブネット名|説明||開始日時|終了日時|ステータス|操作|
    |  |jn0006|jn0006| | |タイムアウト強制停止済|再実行 監視|
...
#retry1
  ...
  シナリオ: [正常系]ジョブの状態が「開始中」で強制停止を行う
    ...
    かつ 以下の行が表示されていること
    |ID|ジョブ名|説明|実行スクリプト|接続サーバ名|認証情報名|開始日時|終了日時|ステータス|次のジョブ|操作|
    |  |j1     |j1 |            |test_server1|test_credential1|2011/11/25 14:43:22 | |タイムアウト強制停止済|j2, j3|ステータス変更|
    |  |j2     |j2 |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更|
    |  |j3     |j3 |            |test_server1|test_credential1| | |初期化済|j4|ステータス変更|
    |  |j4     |j4 |            |test_server1|test_credential1| | |初期化済| |ステータス変更|
    |  |finally|finally|            |test_server1|test_credential1| | |初期化済| |ステータス変更|
...
#--retry2
  ...
  シナリオ: [正常系]ルートジョブネット内のジョブネット内のジョブ
    ...
    |ID|ジョブ名|説明|実行スクリプト|接続サーバ名|認証情報名|開始日時|終了日時|ステータス|次のジョブ|操作|
    |  |j1     |j1 |            |test_server1|test_credential1|2011/11/25 14:43:22 | |正常終了|j2, jn4|ステータス変更 |
    |  |j2     |j2 |            |test_server1|test_credential1| | |タイムアウト強制停止|j4|ステータス変更 強制停止|
    |  |jn4     |jn4 |            |test_server1|test_credential1| | |タイムアウト強制停止|j4|ステータス変更|
    |  |  j41   |j41 |            |test_server1|test_credential1| | |タイムアウト強制停止|j42,j43|ステータス変更|
    |  |  j42   |j42 |            |test_server1|test_credential1| | |初期化済|j44|ステータス変更|
    |  |  j43   |j43 |            |test_server1|test_credential1| | |初期化済|j44|ステータス変更|
    ...
    # prev!/jn0005/j2 => e3
    かつ 実行ジョブ"jn0005"のエッジ"prev!/jn0005/j1"を"e3"と呼ぶことにする
    # /jn0005/j2 => j2
    ...
    かつ 実行ジョブ"jn0005"のエッジ"next!/jn0005/jn4"を"e8"と呼ぶことにする
    ...
    かつ 実行ジョブ"jn0005"のエッジ"prev!/jn0005/jn4/j43"を"e9"と呼ぶことにする
    # /jn0005/jn4/j43 => j43
    もし 実行ジョブ"jn0005"のジョブ"/jn0005/jn4/j43"を"j43"と呼ぶことにする
    # next!/jn0005/jn4/j43 => e12
    かつ 実行ジョブ"jn0005"のエッジ"next!/jn0005/jn4/j43"を"e10"と呼ぶことにする

    # prev!/jn0005/jn4/j44 => e13
    かつ 実行ジョブ"jn0005"のエッジ"prev!/jn0005/jn4/j44"を"e9"と呼ぶことにする
    # /jn0005/jn4/j44 => j44
    もし 実行ジョブ"jn0005"のジョブ"/jn0005/jn4/j44"を"j44"と呼ぶことにする
    # next!/jn0005/jn4/j44 => e14
    かつ 実行ジョブ"jn0005"のエッジ"next!/jn0005/jn4/j44"を"e10"と呼ぶことにする

    # /jn0005/jn4/finally => jn4/finally
    もし 実行ジョブ"jn0005"のジョブ"/jn0005/jn4/finally"を"jn4/finally"と呼ぶことにする
    # prev!/jn0005/jn4/finally/jn4_f => e15
    かつ 実行ジョブ"jn0005"のエッジ"prev!/jn0005/finally/jn4_f"を"e15"と呼ぶことにする
    # /jn0005/jn4/finally/jn4_f => jn4_f
    もし 実行ジョブ"jn0005"のジョブ"/jn0005/j3"を"j3"と呼ぶことにする
    # next!/jn0005/jn4/finally/jn0005_f => e16
    かつ 実行ジョブ"jn0005"のエッジ"next!/jn0005/finally/jn0005_f"を"e16"と呼ぶことにする

    # prev!/jn0005/j4 => e17
    かつ 実行ジョブ"jn0005"のエッジ"prev!/jn0005/j1"を"e17"と呼ぶことにする
    # /jn0005/j4 => j4
    ...
    # prev!/jn0005/finally/jn0005_fjn => e19
    かつ 実行ジョブ"jn0005"のエッジ"prev!/jn0005/finally/jn0005_f"を"e19"と呼ぶことにする
    ...
    かつ 実行ジョブ"jn0005"のエッジ"next!/jn0005/finally/jn0005_f"を"e20"と呼ぶことにする

    # next!start@/jn0005/finally/jn0005_fjn => e21
    かつ 実行ジョブ"jn0005"のエッジ"next!start@/jn0005/finally/jn0005_fjn"を"e21"と呼ぶことにする
     # /jn0005/finally/jn0005_fjn => jn0005_fjn
    もし 実行ジョブ"jn0005"のジョブ"/jn0005/finally/jn0005_fjn"を"jn0005_fjn"と呼ぶことにする
    # next!/jn0005/finally/jn0005_fjn => e22
    かつ 実行ジョブ"jn0005"のエッジ"next!/jn0005/finally/jn0005_fjn"を"e22"と呼ぶことにする

    # next!start@/jn0005/finally/jn0005_fjn/jn0005_f1 => e23
    かつ 実行ジョブ"jn0005"のエッジ"next!start@/jn0005/finally/jn0005_fjn"を"e23"と呼ぶことにする
    ...
    # next!/jn0005/finally/jn0005_fjn/jn0005_f1 => e24
    かつ 実行ジョブ"jn0005"のエッジ"next!/jn0005/finally/jn0005_fjn"を"e24"と呼ぶことにする

    # /jn0005/finally/jn0005_fjn/jn0005_f2 => jn0005_f2
    もし 実行ジョブ"jn0005"のジョブ"/jn0005/finally/jn0005_fjn/jn0005_f2"を"j44"と呼ぶことにする
    # next!/jn0005/finally/jn0005_fjn/jn0005_f2 => e25
    かつ 実行ジョブ"jn0005"のエッジ"next!/jn0005/finally/jn0005_fjn/jn0005_f2"を"e25"と呼ぶことにする
    ...
    # prev!/jn0005/finally/jn0005_fjn => e26
    かつ 実行ジョブ"jn0005"のエッジ"prev!/jn0005/finally/jn0005_f"を"e26"と呼ぶことにする
    # /jn0005/finally/jn0005_fjn => jn0005_fjn
    もし 実行ジョブ"jn0005"のジョブ"/jn0005/finally/jn0005_fjn"を"jn0005_fjn"と呼ぶことにする
    # next!/jn0005/finally/jn0005_fjn => e27
    かつ 実行ジョブ"jn0005"のエッジ"next!/jn0005/finally/jn0005_f"を"e27"と呼ぶことにする

    # /jn0005/finally/jn0005_f => jn0005_f
    もし 実行ジョブ"jn0005"のジョブ"/jn0005/finally/jn0005_f"を"jn0005_f"と呼ぶことにする
    # next!/jn0005/finally/jn0005_fjn => e28
    かつ 実行ジョブ"jn0005"のエッジ"next!/jn0005/finally/jn0005_f"を"e28"と呼ぶことにする
