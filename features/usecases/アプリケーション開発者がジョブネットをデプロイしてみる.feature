...
機能: アプリケーション開発者がジョブネットをデプロイしてみる
  ...
  シナリオ: [正常系]ディレクトリ構成の読込_を試してみる
    ...
    ならば ルートのカテゴリの子に"01_05_01_jobnet_directory"というカテゴリが存在すること
  ...
  シナリオ: [正常系]dictionary.ymlの内容が正しく表示される_を試してみる
    ...
    ならば ルートのカテゴリの子に"01_05_02_dictionary_yml"というカテゴリが存在すること
  ...
  シナリオ: [正常系]dictionary.ymlの内容が間違っている_を試してみる
    ...
    ならば ルートのカテゴリの子に"01_05_04_incorrect_dictionary_yml"というカテゴリが存在すること
