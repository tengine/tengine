...
機能: アプリケーション開発者がイベントハンドラ定義を作成する
  ...
  背景:
    # 前提 イベントハンドラ定義ファイル"aaaa"が存在しない
    # かつ イベントハンドラ定義のテストファイル"aaaa"が存在しない
  ...
  シナリオ: [正常系] アプリケーション開発者がイベントハンドラ定義を開発する
    ...
    # もし イベントハンドラ定義のテストファイル"aaaaa"を作成する
    もし "イベントハンドラ定義のテストファイル""aaaaa"に以下の行を追記する
    """
    ...
    # もし イベントハンドラ定義ファイル"aaaaa"を作成する
    もし "イベントハンドラ定義ファイル""aaaaa"に以下の行を追記する
    """
    ...
    # かつ イベントハンドラが作成したファイル"tmp/event2"が存在すること
