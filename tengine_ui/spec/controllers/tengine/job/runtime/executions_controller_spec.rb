...
describe Tengine::Job::Runtime::ExecutionsController do
  ...
  describe "GET index" do
    it "assigns all tengine_job_runtime_executions as @tengine_job_runtime_executions" do
  ...
  describe "GET new" do
    describe "ジョブネットの実行のとき" do
      ...
      it "root_jobnet_idパラメータがないときテンプレートジョブ一覧にリダイレクトすること" do
        get :new
        assert_redirected_to tengine_job_template_root_jobnets_path
      end
    ...
    describe "ジョブネットの再実行のとき" do
      ...
      it "root_jobnet_idパラメータがないとき実行中のジョブ一覧にリダイレクトすること" do
        get :new, :retry => true
        assert_redirected_to tengine_job_runtime_root_jobnets_path
      end
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested execution" do
        execution = Tengine::Job::Runtime::Execution.create! valid_attributes
        # Assuming there are no other tengine_job_runtime_executions in the database, this
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the tengine_job_runtime_executions list" do
      execution = Tengine::Job::Runtime::Execution.create! valid_attributes
      delete :destroy, :id => execution.id.to_s
      response.should redirect_to(tengine_job_runtime_executions_url)
    end
  end
