...
describe Tengine::Job::Template::RootJobnetsController do
  ...
  describe "GET index" do
    describe "&sort" do
      ...
      it "assigns all tengine_job_template_root_jobnets as @tengine_job_template_root_jobnets" do
        Tengine::Job::Template::RootJobnet.delete_all
      ...
      it "assigns all tengine_job_template_root_jobnets as @root_jobnet_templates" do
        Tengine::Job::Structure::Category.delete_all
        category = Tengine::Job::Structure::Category.create! valid_attributes
        get :index
...
__end_of_dsl__
      ...
      it "@jobnet_templatesの要素にTengine::Job::Template::Expansionが含まれること" do
        jn11 = @root_jobnet_template.child_by_name("jn11")
        jn12 = @root_jobnet_template.child_by_name("jn12")
        jn13 = @root_jobnet_template.child_by_name("jn13")
        jn14 = @root_jobnet_template.child_by_name("jn14")
        ...
        jn16 = finally.child_by_name("jn16")
        jn11.should be_instance_of Tengine::Job::Template::Expansion
        jn12.should be_instance_of Tengine::Job::Template::Expansion
        jn13.should be_instance_of Tengine::Job::Template::Expansion
        jn14.should be_instance_of Tengine::Job::Template::Expansion
        j15.should be_instance_of Tengine::Job::Template::SshJob
        finally.should be_instance_of Tengine::Job::Template::Jobnet
        jn16.should be_instance_of Tengine::Job::Template::Expansion
      end
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested root_jobnet_template" do
        root_jobnet_template = Tengine::Job::Template::RootJobnet.create! valid_attributes
        # Assuming there are no other tengine_job_template_root_jobnets in the database, this
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the tengine_job_template_root_jobnets list" do
      root_jobnet_template = Tengine::Job::Template::RootJobnet.create! valid_attributes
      delete :destroy, :id => root_jobnet_template.id.to_s
      response.should redirect_to(tengine_job_template_root_jobnets_url)
    end
  end
