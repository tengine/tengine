...
describe "tengine/job/runtime/root_jobnets/index.html.erb" do
  context "ページネーションのページが1ページのみのとき" do
    ...
    it "renders a list of tengine_job_runtime_root_jobnets" do
      render
    ...
    it "監視のリンクが表示されていること" do
      ...
      href = tengine_job_runtime_root_jobnet_path(@actual1)
    ...
    context "カテゴリが登録されているとき" do
      ...
      context "nameで検索したとき" do
        ...
        it "カテゴリツリーのリンクにfinderパラメータがついていること" do
          ...
          href = tengine_job_runtime_root_jobnets_path(:finder => {:name => 'foo'})
          rendered.should have_xpath("//a[@href='#{href}']",
      ...
      context "表示名の昇順でソートしたとき" do
        ...
        it "表示名のソートのリンクに降順のパラメータがついていてclassがSortAscであること" do
          ...
          href = tengine_job_runtime_root_jobnets_path(:sort => {:description => 'desc'})
    ...
    context "フェーズがstuckのTengine::Job::Runtime::RootJobnetが登録されているとき" do
      ...
      it "ステータス変更のリンクが表示されていること" do
        ...
        href = edit_tengine_job_runtime_root_jobnet_path(@actual1)
        rendered.should have_xpath("//a[@href='#{href}']",
    ...
    context "ページ移動したとき" do
      ...
      context "カテゴリが登録されているとき" do
        ...
        it "カテゴリのリンクにpageパラメータがついていないこと" do
          ...
          href = tengine_job_runtime_root_jobnets_path(:category => @foo.id)
          rendered.should have_xpath("//a[@href='#{href}']",
            :text => @foo.caption)
        end
      end
