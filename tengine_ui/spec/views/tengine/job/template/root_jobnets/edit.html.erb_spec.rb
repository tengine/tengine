...
describe "tengine/job/template/root_jobnets/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit root_jobnet_template form" do
    ...
    assert_select "form", :action => tengine_job_template_root_jobnets_path(@root_jobnet_template), :method => "post" do
