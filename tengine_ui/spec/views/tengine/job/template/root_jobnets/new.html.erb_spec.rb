...
describe "tengine/job/template/root_jobnets/new.html.erb" do
  before(:each) do
    assign(:root_jobnet_template, stub_model(Tengine::Job::Template::RootJobnet,
      :name => "MyString",
  ...
  it "renders new root_jobnet_template form" do
    ...
    assert_select "form", :action => tengine_job_template_root_jobnets_path, :method => "post" do
