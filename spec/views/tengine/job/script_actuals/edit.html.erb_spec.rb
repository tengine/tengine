...
describe "tengine/job/script_actuals/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit script_actual form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => tengine_job_script_actuals_path(@script_actual), :method => "post" do
      ...
      assert_select "input#script_actual_has_chained_children", :name => "script_actual[has_chained_children]"
