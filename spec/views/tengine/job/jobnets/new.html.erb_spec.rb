...
describe "tengine/job/jobnets/new.html.erb" do
  before(:each) do
    assign(:jobnet, stub_model(Tengine::Job::Jobnet,
      :name => "MyString",
  ...
  it "renders new jobnet form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => tengine_job_jobnets_path, :method => "post" do
