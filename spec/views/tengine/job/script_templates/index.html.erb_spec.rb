...
describe "tengine/job/script_templates/index.html.erb" do
  before(:each) do
    mock_pagination(assign(:script_templates, [
      stub_model(Tengine::Job::ScriptTemplate,
        :name => "Name",
  ...
  it "renders a list of tengine_job_script_templates" do
    render
