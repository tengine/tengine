...
機能: アプリケーション運用者が仮想サーバの状態を取得する
  ...
  シナリオ: [正常系]アプリケーション運用者は仮想サーバ一覧画面を開き、仮想サーバが表示されていることを確認する
    ...
    # 基本コース:
    # 仮想サーバが10件のファイル
    もし Wakameのモックファイル"./features/test_files/11_describe_instances_10_virtual_servers.json"を"./features/test_files/describe_instances.json"にコピーする
    ならば "仮想サーバ一覧"画面に以下の行が表示されていること
    ...
    |                       |virtual_server_uuid_04|virtual_server_uuid_04|    |private_ip_address: 192.168.2.4 <br>nw-data: 192.168.2.4 <br>nw-outside: 172.16.0.4 <br>nw-data_2: 192.168.3.4 <br>nw-outside_2: 172.16.1.4 |shuttingdown|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_05|virtual_server_uuid_05|    |private_ip_address: 192.168.2.5 <br>nw-data: 192.168.2.5 <br>nw-outside: 172.16.0.5 <br>nw-data_2: 192.168.3.5 <br>nw-outside_2: 172.16.1.5 |terminated|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |physical_server_name_02|virtual_server_uuid_06|virtual_server_uuid_06|    |private_ip_address: 192.168.2.6 <br>nw-data: 192.168.2.6 <br>nw-outside: 172.16.0.6 <br>nw-data_2: 192.168.3.6 <br>nw-outside_2: 172.16.1.6 |running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |                       |virtual_server_uuid_07|virtual_server_uuid_07|    |private_ip_address: 192.168.2.7 <br>nw-data: 192.168.2.7 <br>nw-outside: 172.16.0.7 <br>nw-data_2: 192.168.3.7 <br>nw-outside_2: 172.16.1.7 |running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |                       |virtual_server_uuid_08|virtual_server_uuid_08|    |private_ip_address: 192.168.2.8 <br>nw-data: 192.168.2.8 <br>nw-outside: 172.16.0.8 <br>nw-data_2: 192.168.3.8 <br>nw-outside_2: 172.16.1.8 |running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |physical_server_name_03|virtual_server_uuid_09|virtual_server_uuid_09|    |private_ip_address: 192.168.2.9 <br>nw-data: 192.168.2.9 <br>nw-outside: 172.16.0.9 <br>nw-data_2: 192.168.3.9 <br>nw-outside_2: 172.16.1.9 |running|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_10|virtual_server_uuid_10|    |private_ip_address: 192.168.2.10<br>nw-data: 192.168.2.10<br>nw-outside: 172.16.0.10<br>nw-data_2: 192.168.3.10<br>nw-outside_2: 172.16.1.10|running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |physical_server_name_04|仮想サーバは起動していません。|||||||
    |physical_server_name_05|仮想サーバは起動していません。|||||||
    |physical_server_name_06|仮想サーバは起動していません。|||||||
    |physical_server_name_07|仮想サーバは起動していません。|||||||
    ...
    ならば "仮想サーバ一覧"画面に以下の行が表示されていること
    |物理サーバ名             |仮想サーバ名|プロバイダによるID  |説明|IPアドレス|ステータス|仮想サーバイメージ名|仮想サーバタイプ|
    |physical_server_name_01|virtual_server_name_01|virtual_server_uuid_01|仮想サーバ説明01|private_ip_address: 192.168.2.1 <br>nw-data: 192.168.2.1 <br>nw-outside: 172.16.0.1 <br>nw-data_2: 192.168.3.1 <br>nw-outside_2: 172.16.1.1 |running|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_02|virtual_server_uuid_02|              |private_ip_address: 192.168.2.2 <br>nw-data: 192.168.2.2 <br>nw-outside: 172.16.0.2 <br>nw-data_2: 192.168.3.2 <br>nw-outside_2: 172.16.1.2 |running|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_03|virtual_server_uuid_03|              |private_ip_address: 192.168.2.3 <br>nw-data: 192.168.2.3 <br>nw-outside: 172.16.0.3 <br>nw-data_2: 192.168.3.3 <br>nw-outside_2: 172.16.1.3 |starting|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_04|virtual_server_uuid_04|              |private_ip_address: 192.168.2.4 <br>nw-data: 192.168.2.4 <br>nw-outside: 172.16.0.4 <br>nw-data_2: 192.168.3.4 <br>nw-outside_2: 172.16.1.4 |shuttingdown|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_05|virtual_server_uuid_05|              |private_ip_address: 192.168.2.5 <br>nw-data: 192.168.2.5 <br>nw-outside: 172.16.0.5 <br>nw-data_2: 192.168.3.5 <br>nw-outside_2: 172.16.1.5 |terminated|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    ...
    |                       |virtual_server_uuid_04|virtual_server_uuid_04|              |private_ip_address: 192.168.2.4 <br>nw-data: 192.168.2.4 <br>nw-outside: 172.16.0.4 <br>nw-data_2: 192.168.3.4 <br>nw-outside_2: 172.16.1.4 |shuttingdown|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_05|virtual_server_uuid_05|              |private_ip_address: 192.168.2.5 <br>nw-data: 192.168.2.5 <br>nw-outside: 172.16.0.5 <br>nw-data_2: 192.168.3.5 <br>nw-outside_2: 172.16.1.5 |terminated|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |physical_server_name_02|virtual_server_name_06|virtual_server_uuid_06|仮想サーバ説明06|private_ip_address: 192.168.2.6 <br>nw-data: 192.168.2.6 <br>nw-outside: 172.16.0.6 <br>nw-data_2: 192.168.3.6 <br>nw-outside_2: 172.16.1.6 |running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |                       |virtual_server_uuid_07|virtual_server_uuid_07|              |private_ip_address: 192.168.2.7 <br>nw-data: 192.168.2.7 <br>nw-outside: 172.16.0.7 <br>nw-data_2: 192.168.3.7 <br>nw-outside_2: 172.16.1.7 |running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |                       |virtual_server_uuid_08|virtual_server_uuid_08|              |private_ip_address: 192.168.2.8 <br>nw-data: 192.168.2.8 <br>nw-outside: 172.16.0.8 <br>nw-data_2: 192.168.3.8 <br>nw-outside_2: 172.16.1.8 |running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |physical_server_name_03|virtual_server_uuid_09|virtual_server_uuid_09|              |private_ip_address: 192.168.2.9 <br>nw-data: 192.168.2.9 <br>nw-outside: 172.16.0.9 <br>nw-data_2: 192.168.3.9 <br>nw-outside_2: 172.16.1.9 |running|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_10|virtual_server_uuid_10|              |private_ip_address: 192.168.2.10<br>nw-data: 192.168.2.10<br>nw-outside: 172.16.0.10<br>nw-data_2: 192.168.3.10<br>nw-outside_2: 172.16.1.10|running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    ...
    ならば "仮想サーバ一覧"画面に以下の行が表示されていること
    |物理サーバ名             |仮想サーバ名|プロバイダによるID  |説明|IPアドレス|ステータス|仮想サーバイメージ名|仮想サーバタイプ|
    |physical_server_name_01|virtual_server_uuid_04|virtual_server_uuid_04|    |private_ip_address: 192.168.2.4 <br>nw-data: 192.168.2.4 <br>nw-outside: 172.16.0.4 <br>nw-data_2: 192.168.3.4 <br>nw-outside_2: 172.16.1.4 |shuttingdown|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_05|virtual_server_uuid_05|    |private_ip_address: 192.168.2.5 <br>nw-data: 192.168.2.5 <br>nw-outside: 172.16.0.5 <br>nw-data_2: 192.168.3.5 <br>nw-outside_2: 172.16.1.5 |terminated|virtual_server_image_uuid_01|virtual_server_spec_uuid_01|
  ...
  シナリオ: [正常系]仮想サーバイメージ名の変更が仮想サーバ一覧画面の仮想サーバイメージ名に反映されることを確認する
    ...
    もし Wakameのモックファイル"./features/test_files/01_describe_host_nodes_10_physical_servers.json"を"./features/test_files/describe_host_nodes.json"にコピーする
    # 仮想サーバが10件のファイル
    かつ Wakameのモックファイル"./features/test_files/11_describe_instances_10_virtual_servers.json"を"./features/test_files/describe_instances.json"にコピーする
    # 仮想サーバイメージが5件のファイル
    かつ Wakameのモックファイル"./features/test_files/21_describe_images_5_virtual_server_images.json"を"./features/test_files/describe_images.json"にコピーする
    # 仮想サーバタイプが4件のファイル
    かつ Wakameのモックファイル"./features/test_files/31_describe_instance_specs_4_virtual_server_specs.json"を"./features/test_files/describe_instance_specs.json"にコピーする
    ...
    # 仮想サーバ名、説明はつけていないので、空の状態です。
    |物理サーバ名             |仮想サーバ名           |プロバイダによるID       |説明|IPアドレス                                                                            |ステータス    |仮想サーバイメージ名   |仮想サーバタイプ|
    |physical_server_name_01|virtual_server_uuid_01|virtual_server_uuid_01|仮想サーバイメージ説明01|private_ip_address: 192.168.2.1 <br>nw-data: 192.168.2.1 <br>nw-outside: 172.16.0.1 <br>nw-data_2: 192.168.3.1 <br>nw-outside_2: 172.16.1.1 |running|virtual_server_image_name_01|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_02|virtual_server_uuid_02|                     |private_ip_address: 192.168.2.2 <br>nw-data: 192.168.2.2 <br>nw-outside: 172.16.0.2 <br>nw-data_2: 192.168.3.2 <br>nw-outside_2: 172.16.1.2 |running|virtual_server_image_name_01(仮想サーバイメージ説明01)|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_03|virtual_server_uuid_03|                     |private_ip_address: 192.168.2.3 <br>nw-data: 192.168.2.3 <br>nw-outside: 172.16.0.3 <br>nw-data_2: 192.168.3.3 <br>nw-outside_2: 172.16.1.3 |starting|virtual_server_image_name_01(仮想サーバイメージ説明01)|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_04|virtual_server_uuid_04|                     |private_ip_address: 192.168.2.4 <br>nw-data: 192.168.2.4 <br>nw-outside: 172.16.0.4 <br>nw-data_2: 192.168.3.4 <br>nw-outside_2: 172.16.1.4 |shuttingdown|virtual_server_image_name_01(仮想サーバイメージ説明01)|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_05|virtual_server_uuid_05|                     |private_ip_address: 192.168.2.5 <br>nw-data: 192.168.2.5 <br>nw-outside: 172.16.0.5 <br>nw-data_2: 192.168.3.5 <br>nw-outside_2: 172.16.1.5 |terminated|virtual_server_image_name_01(仮想サーバイメージ説明01)|virtual_server_spec_uuid_01|
    |physical_server_name_02|virtual_server_uuid_06|virtual_server_uuid_06|                     |private_ip_address: 192.168.2.6 <br>nw-data: 192.168.2.6 <br>nw-outside: 172.16.0.6 <br>nw-data_2: 192.168.3.6 <br>nw-outside_2: 172.16.1.6 |running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |                       |virtual_server_uuid_07|virtual_server_uuid_07|                     |private_ip_address: 192.168.2.7 <br>nw-data: 192.168.2.7 <br>nw-outside: 172.16.0.7 <br>nw-data_2: 192.168.3.7 <br>nw-outside_2: 172.16.1.7 |running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |                       |virtual_server_uuid_08|virtual_server_uuid_08|                     |private_ip_address: 192.168.2.8 <br>nw-data: 192.168.2.8 <br>nw-outside: 172.16.0.8 <br>nw-data_2: 192.168.3.8 <br>nw-outside_2: 172.16.1.8 |running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |physical_server_name_03|virtual_server_uuid_09|virtual_server_uuid_09|                     |private_ip_address: 192.168.2.9 <br>nw-data: 192.168.2.9 <br>nw-outside: 172.16.0.9 <br>nw-data_2: 192.168.3.9 <br>nw-outside_2: 172.16.1.9 |running|virtual_server_image_name_01(仮想サーバイメージ説明01)|virtual_server_spec_uuid_01|
    |                       |virtual_server_uuid_10|virtual_server_uuid_10|                     |private_ip_address: 192.168.2.10<br>nw-data: 192.168.2.10<br>nw-outside: 172.16.0.10<br>nw-data_2: 192.168.3.10<br>nw-outside_2: 172.16.1.10|running|virtual_server_image_uuid_02|virtual_server_spec_uuid_02|
    |physical_server_name_04|仮想サーバは起動していません。|||||||
    |physical_server_name_05|仮想サーバは起動していません。|||||||
    |physical_server_name_06|仮想サーバは起動していません。|||||||
