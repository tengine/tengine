...
# error.job.job.tengine(2) #
  シナリオ: [異常系]error.job.job.tengineのイベント処理中に、start.jobnet.job.tengineを発火した後に、Coreサーバがダウンする_start.jobnet.job.tengineがイベント処理失敗イベントの前に処理される
...
# 以下フェイルバックの確認
  ...
  @08_06_08_03
  シナリオ: [異常系]error.job.job.tengineのイベント処理中に、start.jobnet.job.tengineを発火した後に、Coreサーバがダウンする_start.jobnet.job.tengineがイベント処理失敗イベントの後に処理される
#上と変わらず

  @08_06_08_04
  シナリオ: [異常系]error.job.job.tengineのイベント処理中に、error.jobnet.job.tengineを発火した後に、Coreサーバがダウンする_error.jobnet.job.tengineがイベント処理失敗イベントの前に処理される
...
# 以下フェイルバックの確認
    ...
    @08_06_08_05
   シナリオ: [異常系]error.job.job.tengineのイベント処理中に、error.jobnet.job.tengineを発火した後に、Coreサーバがダウンする_error.jobnet.job.tengineがイベント処理失敗イベントの後に処理される
