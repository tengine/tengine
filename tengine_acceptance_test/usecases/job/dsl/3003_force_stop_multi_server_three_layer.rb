...
jobnet("jn0006", :instance_name => "test_server1", :credential_name => "test_credential1") do
  boot_jobs("jn1")
  jobnet("jn1", :instance_name => "test_server2", :credential_name => "test_credential2", :to => "jn2") do
   boot_jobs("jn11")
   jobnet("jn11", :instance_name => "test_server3", :to => "j12") do
     boot_jobs("j111")
     job("j111", "$HOME/0006_retry_three_layer.sh", :instance_name => "test_server2",:to => "j112")
     job("j112", "$HOME/0006_retry_three_layer.sh", :credential_name => "test_credential3" )
     finally do
       job("jn11_f","$HOME/0006_retry_three_layer.sh", :instance_name => "test_server1", :credential_name => "test_credential1")
     end
   end
